...
# FINGER_FEATURES_FILE = os.path.join(BASE_DIR,"data/synthetic_data/park_train_synthetic_merged_filtered/finger_embeddings.csv")
FINGER_FEATURES_FILE = os.path.join(BASE_DIR,"data/synthetic_data/park_train_synthetic_merged_filtered/finger_embeddings_empty.csv")
...
# FINGER_FEATURES_FILE = os.path.join(BASE_DIR,"data/synthetic_data/merged_maskedvae/finger_embeddings.csv")
# AUDIO_FEATURES_FILE = os.path.join(BASE_DIR,"data/synthetic_data/merged_maskedvae/quick_embeddings.csv")
# FACIAL_FEATURES_FILE = os.path.join(BASE_DIR, "data/synthetic_data/merged_maskedvae/smile_embeddings.csv")
