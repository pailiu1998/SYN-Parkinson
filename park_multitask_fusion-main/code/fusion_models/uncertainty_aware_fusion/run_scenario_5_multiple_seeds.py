#!/usr/bin/env python
"""
Run scenario 5 with multiple random seeds and compute confidence intervals
"""
import os
import json
import numpy as np
...
def run_experiment(seed):
    ...
    # Run the uncertainty_aware_fusion_scenario_5.py with the given seed
    cmd = [
        sys.executable,
        "uncertainty_aware_fusion_scenario_5.py",
        f"--seed={seed}"
    ]
...
def main():
    ...
    results_dir = f"scenario_5_results_{timestamp}"
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"\n{'='*70}")
    print(f"Running Scenario 5 with seeds 0-100")
