...
# 配置
SCRIPT_NAME = "uncertainty_aware_fusion_scenario_10.py"
NUM_SEEDS = 100
START_SEED = 0
PARALLEL_JOBS = 10
OUTPUT_DIR = "scenario_10_results"
TIMEOUT = 7200  # 2小时超时
        ...
        if result.returncode == 0:
            ...
            for filename in ["fusion_model_results_test.json", "fusion_model_results_dev.json"]:
                if os.path.exists(filename):
                    os.rename(filename, os.path.join(seed_dir, filename))
...
def main():
    """主函数"""
    print("="*70)
    print("Scenario 10 - Batch Training with 100 Seeds")
    print("="*70)
