...
from constants_scenario_11 import *
...
def main(**cfg):
    ...
    for epoch in tqdm(range(cfg['num_epochs'])):
        ...
        print(f"Epoch {epoch}: Dev F1: {dev_f1:.4f}, Dev AUROC: {dev_auroc:.4f}, Dev Balanced Accuracy: {dev_balanced_accuracy:.4f}, Dev Loss: {dev_loss:.4f}")
    ...
    print("\n" + "="*70)
    print("BEST DEV SET METRICS")
    print("="*70)
    print(f"Dev F1 Score:           {best_dev_f1:.4f}")
    print(f"Dev AUROC:              {best_dev_auroc:.4f}")
    print(f"Dev Balanced Accuracy:  {best_dev_balanced_accuracy:.4f}")
    print(f"Dev Accuracy:           {best_dev_accuracy:.4f}")
    print(f"Dev Loss:               {best_dev_loss:.4f}")
    print(f"Dev ECE:                {best_dev_ece:.4f}")
    print("="*70 + "\n")
