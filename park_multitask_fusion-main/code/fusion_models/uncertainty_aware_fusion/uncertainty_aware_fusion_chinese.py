...
from constants_chinese_syn_speech import *
...
with open(os.path.join(BASE_DIR,"data/chinese_synthetic_data/real_chinese_smile_finger/processed/data/dev_set_participants.txt")) as f:
# with open(os.path.join(BASE_DIR,"data/dev_set_participants.txt")) as f:
    ids = f.readlines()
    dev_ids = set([x.strip() for x in ids])
with open(os.path.join(BASE_DIR,"data/chinese_synthetic_data/real_chinese_smile_finger/processed/data/test_set_participants.txt")) as f:
