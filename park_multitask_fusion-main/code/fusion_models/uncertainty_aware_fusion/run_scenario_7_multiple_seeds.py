#!/usr/bin/env python
"""
Run scenario 7 with multiple random seeds and compute confidence intervals
"""
import os
import json
import numpy as np
...
def run_experiment(seed):
    ...
    # Run the uncertainty_aware_fusion_scenario_7.py with the given seed
    cmd = [
        sys.executable,
        "uncertainty_aware_fusion_scenario_7.py",
        f"--seed={seed}"
    ]
...
def main():
    ...
    results_dir = f"scenario_7_results_{timestamp}"
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"\n{'='*70}")
    print(f"Running Scenario 7 with seeds 0-100")
