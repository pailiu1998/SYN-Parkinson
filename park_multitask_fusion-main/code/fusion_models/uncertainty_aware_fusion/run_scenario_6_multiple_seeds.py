#!/usr/bin/env python
"""
Run scenario 6 with multiple random seeds and compute confidence intervals
"""
import os
import json
import numpy as np
...
def run_experiment(seed):
    ...
    # Run the uncertainty_aware_fusion_scenario_6.py with the given seed
    cmd = [
        sys.executable,
...
def main():
    ...
    results_dir = f"scenario_6_results_{timestamp}"
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"\n{'='*70}")
    print(f"Running Scenario 6 with seeds 0-100")
