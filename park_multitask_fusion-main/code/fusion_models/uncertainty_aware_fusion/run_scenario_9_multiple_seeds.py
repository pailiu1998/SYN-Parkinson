#!/usr/bin/env python
"""
Run scenario 9 with multiple random seeds and compute confidence intervals
"""
import os
import json
import numpy as np
...
def main():
    ...
    results_dir = f"scenario_9_results_{timestamp}"
    os.makedirs(results_dir, exist_ok=True)
    
    print(f"\n{'='*70}")
    print(f"Running Scenario 9 with seeds 0-100")
