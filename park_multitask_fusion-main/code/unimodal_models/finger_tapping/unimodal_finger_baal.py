...
@click.option("--dropout_prob", default=0.13951215957675367) # 0.24180259124462203
@click.option("--num_trials", default=300, help="Options: 100, 500, 1000, 5000, 10000, 50000")     # 1000
...
@click.option("--learning_rate", default=0.6682837019078968, help="Learning rate for classifier") # 0.3081959128766984
@click.option("--random_state", default=526, help="Random state for classifier")
@click.option("--seed", default=526, help="Seed for random")
...
@click.option("--batch_size",default=512)   # 256
@click.option("--num_epochs",default=73) # 87
...
@click.option("--momentum",default=0.8363833208184809)  # 0.9206317439937552
@click.option("--use_scheduler",default='yes',help="Options: yes, no")  # no
@click.option("--scheduler",default='step',help="Options: step, reduce")  # reduce
@click.option("--step_size",default=22) # 18
@click.option("--gamma",default=0.6555323541714391)  # 0.683941938387959
@click.option("--patience",default=18)  # 13
...
# @click.command()
# @click.option("--model", default="ShallowANN", help="Options: ANN, ShallowANN")
# @click.option("--dropout_prob", default=0.19198249444170287)
# @click.option("--num_trials", default=1000, help="Options: 100, 500, 1000, 5000, 10000, 50000")
# @click.option("--num_buckets", default=20, help="Options: 5, 10, 20, 50, 100")
# @click.option("--hand", default="both", help="Options: left, right, both")
# @click.option("--learning_rate", default=0.6890265216847128, help="Learning rate for classifier")
# @click.option("--random_state", default=526, help="Random state for classifier")
# @click.option("--seed", default=790, help="Seed for random")
# @click.option("--use_feature_scaling", default='yes', help="yes if you want to scale the features, no otherwise")
# @click.option("--scaling_method", default='StandardScaler', help="Options: StandardScaler, MinMaxScaler")
# @click.option("--minority_oversample", default='no', help="Options: 'yes', 'no'")
# @click.option("--batch_size", default=256)
# @click.option("--num_epochs", default=80)
# @click.option("--drop_correlated", default='no', help="Options: yes, no")
...
# @click.option("--beta2", default=0.999)
# @click.option("--weight_decay", default=0.0001)
# @click.option("--momentum", default=0.9478264460628651)
# @click.option("--use_scheduler", default='yes', help="Options: yes, no")
# @click.option("--scheduler", default='reduce', help="Options: step, reduce")
# @click.option("--step_size", default=19)
# @click.option("--gamma", default=0.7537928328291398)
